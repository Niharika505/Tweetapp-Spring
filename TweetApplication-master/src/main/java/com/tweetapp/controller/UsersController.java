...
public class UsersController {
	...
	@RequestMapping(path = "/api/v1.0/user/logout" , method = RequestMethod.POST)
	public UserResponse logoutUser(@RequestBody UserRequest request) {
		UserResponse response = usersService.logoutuser(request);
